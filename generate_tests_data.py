...
models = {
    'hammersteinwiener': HammersteinWiener(1, 16, 8, 3, 8, 16, 1, mu, sigma),
    'hammersteinwienerlight': HammersteinWienerLight(1, 16, 16, 3, 8, 16, 1, 3, mu, sigma),
    ...
    'wavenet': WaveNet(1, 8, 1, 3, [1, 2, 4, 8, 16, 32, 64], 1, False, 16, mu, sigma)
}
